...
For each assignment in this course, you will start with forking a GitHub repo located under the 'Repositories' tab in our GitHub Team section.
The repo contains the starter documents you will build upon when working on your assignment.
...
### Step 2. Go to RStudio and clone the repo

Go to RStudio and create a **New Project from Git Repo**.
You will need to click on **New Project** --\> **Version Control** --\> **Git** --\> and paste repo url in 'Ropository URL' field.
